<template>
      ...
      <q-list bordered padding class="rounded-borders">
        ...
        <q-item >
          <q-item-section>
            <q-item-label><strong>{{$t('customerName')}}</strong></q-item-label>
        ...
        <q-item >
          <q-item-section>
            <q-item-label><strong>{{$t('email')}}</strong></q-item-label>
        ...
        <q-item >
          <q-item-section>
            <q-item-label><strong>{{ $t('phone') }}</strong></q-item-label>
        ...
        <q-item>
          <q-item-section>
            ...
            <q-item-label caption>{{ formatDate(customer?.createdAt) }}</q-item-label>
          </q-item-section>
        </q-item>
        <q-separator />
        ...
        <q-item>
          <q-item-section>
            ...
            <q-item-label caption>{{ formatDate(customer?.updatedAt) }}</q-item-label>
          </q-item-section>
        </q-item>
