...
func (d *DB) ClientExists(conn *pgx.Conn, id string) (bool, error) {
...
func (d *DB) InsertClient(conn *pgx.Conn, client entity.Client) error {
...
func (d *DB) GetClientByID(conn *pgx.Conn, id string) (*entity.Client, error) {
